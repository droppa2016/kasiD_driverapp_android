...
public class CompleteBookingsAdapter extends RecyclerView.Adapter<CompleteBookingsAdapter.ViewHolder> {
    ...
    public CompleteBookingsAdapter(Context context, ArrayList<Booking> bookings) {
    ...
    @NonNull
    @Override
    public CompleteBookingsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CompleteBookingsAdapter.ViewHolder holder, int position) {
